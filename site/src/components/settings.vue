...
<template>
  ...
  >
    ...
    >
      <shortcuts v-if="settingState === SettingState.shortcuts"></shortcuts>
      <Background v-if="settingState === SettingState.background"></Background>
      <SearchEngine
        v-if="settingState === SettingState.searchEngine"
      ></SearchEngine>
    </div>
